...
namespace Basil_ror2
{
    ...
    {
        public BlacklistProperties[] blacklistProperties = new BlacklistProperties[]
        {
            ...
            new BlacklistProperties("DroneBackupMaster", DII.CBItemBackup.Value, DII.CBItemCapBackup.Value),
            ...
            new BlacklistProperties("BeetleGuardAllyMaster", DII.CBItemQueensGuard.Value, DII.CBEquipQueensGuard.Value, DII.CBItemCapQueensGuard.Value),
